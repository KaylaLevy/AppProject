...
public class q_issues2 extends AppCompatActivity {
    final String url_Register = "https://lamp.ms.wits.ac.za/home/s2141916/user_issues2.php";
    private String un = LoginUser.getCurrentUsername();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_q_issues2);

        Button btnNext = (Button) findViewById(R.id.btn_nextI2Pg);
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.equalsIgnoreCase("issue entered successfully")) {
                        ...
                        Intent i = new Intent(q_issues2.this, q_completed_message.class);
                        startActivity(i);
                    } else {
    ...
    public void showToast(final String text)
    {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(q_issues2.this, text, Toast.LENGTH_LONG).show();
            }
        });
    }
