...
public class q_language extends AppCompatActivity {

    final String url_Register = "https://lamp.ms.wits.ac.za/home/s2141916/user_lang.php";
    private String un = LoginUser.getCurrentUsername();

    private static String language1;
    private static String language2;
    public static String getLang1(){ return  language1; }
    public static String getLang2(){ return  language2; }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_q_language);
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.equalsIgnoreCase("LANG1 and LANG2 entered successfully")) {
                        showToast("LANG1 and LANG2 entered successfully");

                        Intent i =  new Intent(q_language.this, q_relationship.class);
                        startActivity(i);
                    } else {
    ...
    public void showToast(final String text)
    {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(q_language.this, text, Toast.LENGTH_LONG).show();
            }
        });
    }
}
