...
public class c_issues extends AppCompatActivity {
    final String url_Register = "https://lamp.ms.wits.ac.za/home/s2141916/councellor_issues.php";
    private String un = LoginUser.getCurrentUsername();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_c_issues);
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.equalsIgnoreCase("issue entered successfully")) {
                        ...
                        Intent i = new Intent(c_issues.this, c_issues2.class);
                        c_issues.this.startActivity(i);
                    } else {
    ...
    public void showToast(final String text)
    {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(c_issues.this, text, Toast.LENGTH_LONG).show();
            }
        });
    }
}
